    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.experience_user')),
                ('skills_tags_user', models.ManyToManyField(blank=True, to='accounts.TagsUser')),
